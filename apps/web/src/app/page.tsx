  ...
  useEffect(() => {
    ...
    const update = () => {
      bentoMap.forEach(({ id, lg }) => {
        ...
        if (el)
          el.style.gridColumn = window.innerWidth >= 1024 ? lg : "span 12";
      });
    };
    update();
    ...
    <>
          ...
          >
            ...
            >
              <span className="section-label" style={{ width: "fit-content" }}>
                <Star size={12} fill="currentColor" /> 적립식 투자 포트폴리오
                관리
              </span>
              <h1
                style={{
            ...
            >
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  ...
                  >
                    워런 버핏, 레이 달리오, 캐시 우드 등 5명의 투자 대가
                    포트폴리오를 탭 하나로 불러오세요. 철학, CAGR, MDD까지
                    한눈에 비교됩니다.
                  </p>
                  <div
            ...
            >
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  >
                    월 투자금과 보유 주수만 입력하면 종목별 매수·매도·유지
                    액션과 정확한 주문 수량까지 자동으로 계산해드립니다.
                  </p>
            ...
            >
              <div className="flex flex-col md:flex-row gap-8 md:items-start">
                <div style={{ flex: "0 0 auto", maxWidth: 360 }}>
                  ...
                  <p
                    style={{ fontSize: 15, color: "#6b6b7b", lineHeight: 1.7 }}
                  >
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
                  {[journalEntries[5][0], journalEntries[10][0]].map(
                    (entry) => (
                      <div
                        key={entry.ticker}
                        style={{
      ...
      <section id="portfolios" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            * CAGR·MDD는 백테스트 기반 참고값입니다. 실제 수익률과 다를 수
            있으며 투자 참고 자료로만 활용하세요.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              ...
              >
                단순 적립이 아닙니다. 보유 현황을 반영해 목표 비율 대비 부족한
                종목은 매수하고, 초과된 종목은 매도하도록 안내합니다.
              </p>
                ...
                >
                  {journalEntries[25].map((entry, i) => (
                    ...
                    >
                      ...
                      >
                        <p
                          style={{ fontSize: 12, color: "#6b6b7b", margin: 0 }}
                        >
                          {entry.memo}
                        </p>
                      </div>
      ...
      {/* ── Footer ── */}
      <footer
        style={{ background: "#f8f9fe", borderTop: "1.5px solid #ebebef" }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div style={{ paddingTop: 12 }}>
            <p style={{ fontSize: 11, color: "#9ca3af", lineHeight: 1.7 }}>
              ...
              않습니다. 모든 투자 결정은 투자자 본인의 판단과 책임 하에
              이루어져야 합니다.
              <br />
              CAGR·MDD는 백테스트 기반 참고값으로 실제 수익률과 다를 수 있으며,
              원금 손실의 위험이 있습니다.
            </p>
